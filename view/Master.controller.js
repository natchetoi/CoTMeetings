...
fusion.util.Controller.extend("fusion.view.Master", {
...
/*		var page = this.getView().byId("");
            var header = $("#__xmlview2--page-intHeader-BarPH");
            header.css("background-image", "../Images/MyMeetingsHeader.png");
*/
			var newButton = this.getView().byId("newButtonId" );
			newButton.addEventDelegate({
				 onAfterRendering: function(){
        			newButton.focus();
				 }
			});
